        ...
        >
          ...
          <div className={cn('flex items-center gap-8', isPositionRight && 'justify-end')}>
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className={cn(
                'group flex h-16 w-16 shrink-0 cursor-pointer items-center justify-center rounded-none border border-white/20 bg-white/5 transition-colors duration-300 hover:border-white/60 hover:bg-white/10',
